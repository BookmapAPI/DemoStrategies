...
import velox.api.layer1.simplified.ParametersChangedListener;
import velox.api.layer1.simplified.TradeDataListener;

@Layer1SimpleAttachable
@Layer1StrategyName("Last trade: live (with parameters)")
@Layer1ApiVersion(Layer1ApiVersionValue.VERSION2)
public class LastTradeDemoNoHistoryAutogeneratedParameters implements CustomModule, TradeDataListener, ParametersChangedListener {
    ...
    @Parameter(name = "Sample text", step = 0.0, isReloadIfChanged = true)
    String any = "Any";
